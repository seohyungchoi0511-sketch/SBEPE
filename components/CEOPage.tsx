              ...
              <div className="space-y-8 text-base md:text-lg text-slate-600 leading-relaxed text-justify">
                <div className="text-slate-900 font-semibold text-2xl leading-[1.6] border-l-4 border-blue-600 pl-6 mb-10 py-1 tracking-tight">
                  ...
                  <p>
                    ...
                    <span className="text-blue-600">(주)서울건축종합기술사사무소</span> 대표이사 유병호입니다.
                  </p>
                </div>

                <p>
                  (주)서울건축종합기술사사무소는 토목, 건축, 기계, 전기관련 국내 최고의 하자진단, 법원 감정, 설계 검토, 건설사업관리, 구조물 실태변경, 도시정비 사업, 기술 정책 연구용역 전문회사로서 세계적인 EC(Engineering & Construction) 회사로 발돋움하고 있습니다.
                </p>
                <p>
                ...
                <p>
                  21세기를 리드하는 융합 엔지니어링 회사인 (주)서울건축종합기술사사무소는 이러한 시대적 상황을 인식하고 건축, 토목, 기계 분야의 최고 전문가들로 구성된 사원(社員)들과 함께 전문 기술인의 책무를 성실하게 구현하겠습니다.
                </p>
                <p>
